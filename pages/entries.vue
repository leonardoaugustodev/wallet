                  ...
                  <v-container>
                    <v-row>
                      <v-col>
                        ...
                        <!-- TICKER -->
                        <v-text-field
v-model="editedItem.ticker.code" label="Ticker"
                          outlined dense @change="retrieveTickerInfo"></v-text-field>

                        <!-- NAME -->
                        <v-text-field v-model="editedItem.ticker.name" label="Name" outlined dense></v-text-field>

                        <!-- GROUP -->
                        <v-combobox
v-model="editedItem.ticker.group" :items="tickerGroups" label="Group" outlined
                          dense></v-combobox>
...
v-model="menu2" :close-on-content-click="false" :nudge-right="40"
                          ...
                          <template #activator="{ on, attrs }">
                            <v-text-field
v-model="editedItem.date" label="Date" readonly v-bind="attrs"
                        ...
                        <!-- UNIT PRICE -->
                        <v-text-field
v-model="editedItem.unitPrice" label="Unit Price"
                          outlined dense @change="updateEntryTotal"></v-text-field>

                        <!-- QUANTITY -->
                        <v-text-field
v-model="editedItem.quantity" label="Quantity"
                          outlined dense @change="updateEntryTotal"></v-text-field>

                        <!-- TOTAL -->
                        <v-text-field v-model="editedItem.total" label="Total" readonly outlined dense></v-text-field>
                      </v-col>
                    </v-row>
                  </v-container>
                </v-card-text>
